...
{ 
	...
	if($_POST["username"] != $_SESSION['username'] || $_POST["password"] != $_SESSION['password']  || $_POST["Fname"] != $_SESSION['Fname'] || $_POST["Lname"] != $_SESSION['Lname'])
	{
		...
		$sql = "update reader set username='".$_POST["username"]."', password='".$_POST["password"]."', Fname='".$_POST["Fname"]."' , Lname='".$_POST["Lname"]."' where id=".$_SESSION["ID"];
		$sql2 = "SELECT id, username FROM reader WHERE username='" . $_POST['username'] ."'";
