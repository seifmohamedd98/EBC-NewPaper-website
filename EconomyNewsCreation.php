<?php
	...
	//{
		...
		if(isset($_POST['submit']))
		{
			...
			{
				$sql="INSERT INTO economy_news(news_title,news_short_description,news_full_content,news_author,news_published_on,news_image) VALUES('".$_POST['news_title']."','".$_POST["news_short_description"]."','".$_POST["news_full_content"]."','".$_POST["news_author"]."','".$_POST["news_published_on"]."','".$_POST['news_image']."')";
...
<div id="page">
	...
	<div class="bootstrap-iso"> <h1 class="jumbotron">Economy News Creation</h1> </div>
