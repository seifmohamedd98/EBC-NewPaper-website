...
{ 
    ...
    if($flag==true)
    {
      $sql="insert into reader(email,username,password,Fname,Lname,bday,gender,picupl,access) values('".$_POST['email']."','".$_POST["username"]."','".$_POST["password"]."','".$_POST["Fname"]."','".$_POST["Lname"]."','".$_POST["bday"]."','".$_POST["gender"]."','".$_POST["picupl"]."','".$_POST["accountType"]."')";
...
<head>
  <title>Create Account | EBC</title>
